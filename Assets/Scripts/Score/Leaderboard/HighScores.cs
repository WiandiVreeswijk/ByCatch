...
{
    const string privateCode = "XXIRM6mbKEKTzA_DsYtDjAABrdtgtAR0aHZnjDZza3lw";  //Key to Upload New Info
    const string publicCode = "63128d288f40bba6d07f7553";   //Key to download
